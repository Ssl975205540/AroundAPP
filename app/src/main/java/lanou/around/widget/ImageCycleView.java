...
public class ImageCycleView extends LinearLayout {
  ...
  //  private TextView imageName;
     ...
     */
    public void setImageResources(List<String> images, int page,
...
//            rewardList.add(num);
       // }
        ...
        for (int i = 0; i < imageCount; i++) {
            ...
            if (i == 0) {
                mImageViews.get(i)
                        .setBackgroundResource(R.mipmap.nullbanner);
            } else {
                mImageViews.get(i)
                        .setBackgroundResource(R.mipmap.banner);
            }
            mGroup.addView(mImageViews.get(i));
        }

      //  imageName.setText("打赏(" + rewardList.get(page) + ")");
        mAdvAdapter = new ImageCycleAdapter(mContext, images, page,imageCycleViewListener);
    ...
    private final class GuidePageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int index) {
            index = index % mImageViews.size();
            // 设置图片滚动指示器背
            mImageViews.get(index)
                    .setBackgroundResource(R.mipmap.banner);
    ...
    private class ImageCycleAdapter extends PagerAdapter {
     ...
     //   private JSONArray jsonArray = new JSONArray();
        ...
        public ImageCycleAdapter(Context context, List<String> imageArray,
            ...
            if (mImageViewCacheList.isEmpty()) {
                ...
                imageView.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mImageCycleViewListener.onImageClick(position % imageArray.size(), v);
                    }
                });
            } else {
...
//            imageView.setTag(imageUrl);
            ...
            mImageCycleViewListener.displayImage(imageArray.get(position), imageView);
            return imageView;
        }
